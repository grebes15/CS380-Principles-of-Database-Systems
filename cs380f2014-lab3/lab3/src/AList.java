	...
	public static void findByJo(String pullOutput)
	{
		...
		try {
			...
			for (String result : res)
			{
				...
				System.out.println("Time of findByJo() with data-structure ArrayList: " + estimatedTime + " nanoseconds");
			}
		...
		public static void findByHand(String pullOutput) {
			...
			ArrayList<String> pullList = new ArrayList<String>(); // holds lines that contain the pull value
			...
			long endTime = System.nanoTime();
			long estimatedTime = endTime - startTime;
			System.out.println("Time of findByHand() with data-structure ArrayList: " + estimatedTime + " nanoseconds");
