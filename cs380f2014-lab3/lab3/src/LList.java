...
public class LList {
	...
	public static void findByJo(String pullOutput)
	{
			...
			for (String result : res)
			{
				...
				System.out.println("Time of findWinterByJo() with data-structure LinkedList: " + estimatedTime + " nanoseconds");
			}
	...
	public static void findByHand(String pullOutput) {
			...
			LinkedList<String> pullList = new LinkedList<String>(); // holds lines that contain the pull value
			...
			long endTime = System.nanoTime();
			long estimatedTime = endTime - startTime;
			System.out.println("Time of findByHand() with data-structure LinkedList: " + estimatedTime + " nanoseconds");
